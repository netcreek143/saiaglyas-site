...
This guide explains how to deploy your "saiaglyas" e-commerce application for free using Vercel (frontend/backend) and MongoDB Atlas (database).
...
3.  **Create a Database User**:
    ...
    -   Enter a username (e.g., `slooze-admin`) and a strong password. **Write these down!**
...
5.  **Get Connection String**:
    ...
    -   **Important**: Add the database name after the domain slash. e.g., `...mongodb.net/slooze?retry...`
...
1.  **Import Project**:
    ...
    -   Import your `slooze-frontend` repository.
2.  **Configure Project**:
